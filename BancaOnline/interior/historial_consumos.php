  ...
  text-align:center;
    ...
    <body>
        <div align="center" class="example-card" >
            <br>
            <div class="arreglar">
            <font size="5"><h1>Historial Consumos</h1></font><br><br>
            <form name="datos" method="post">
                <tr>
                <table border ="1">
                    <tr>
                        <td><b>&nbsp;&nbsp;&nbsp;Numero de Tarjeta&nbsp;&nbsp;&nbsp;</b></td>
                        <td><b>&nbsp;&nbsp;&nbsp;Fecha de Consumo&nbsp;&nbsp;&nbsp;</b></td>
                        <td><b>&nbsp;&nbsp;&nbsp;Tienda&nbsp;&nbsp;&nbsp;</b></td>   
                        <td><b>&nbsp;&nbsp;&nbsp;Monto&nbsp;&nbsp;&nbsp;</b></td>  
                    ...
                    <?php
                        ...
                        $sql ="select * from consumos c,tarjetas t where t.cliente = $dpiuser and  c.tarjeta=t.numerotarjeta";
